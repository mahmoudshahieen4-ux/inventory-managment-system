...
import { Settings, Palette, Zap, ShieldCheck } from 'lucide-react'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
type PreferencePane = 'general' | 'appearance' | 'advanced' | 'security'
        ...
        <SidebarProvider className="items-start">
          ...
          <main className="flex flex-1 flex-col overflow-hidden">
            ...
            <div className="flex flex-1 flex-col gap-4 overflow-y-auto p-4 pt-0 max-h-[calc(600px-4rem)]">
              ...
              {activePane === 'security' && <SecurityPane />}
